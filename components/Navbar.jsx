        ...
        <div className='flex flex-initial flex-row justify-end'>
          <div className='flex items-center mr-2'>
            <input type='checkbox'
              ...
              className='flexBetween w-8 h-4 bg-black rounded-2xl p-1 relative label hover:cursor-pointer'>
          ...
          {isOpen ? 
            (
              <Image src={images.cross}
                ...
                className={`${theme === 'light' ? 'filter invert' : '' } hover:cursor-pointer`}
                 />
              ) : (
            ...
            {isOpen && (
              <div className='fixed inset-0 top-65 dark:bg-nft-dark bg-white z-10 nav-h flex justify-between flex-col'>
                <div className='flex-1 p-4'>
                  <MenuItems active={active} setActive={setActive} isMobile setIsOpen={setIsOpen}></MenuItems>
                </div>
