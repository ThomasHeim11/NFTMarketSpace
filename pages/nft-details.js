    ...
    <div className='flex flex-col'>
      ...
      <div className='flexBetween'>
        <p className='font-poppins dark:text-white text-nft-black-1 font-semibold
          text-base minlg:text-xl'>Item</p>
        <p className='font-poppins dark:text-white text-nft-black-1 font-semibold
          text-base minlg:text-xl'>Subtotal</p>
      </div>
      {/* Row 2 */}
      <div className='flexBetweenStart my-5'>
        <div className='flex-1 flexStartCenter'>
          ...
          <div className='flexCenterStart flex-col ml-5'>
            <p className='font-poppins dark:text-white text-nft-black-1 font-semibold
              text-sm minlg:text-xl'>{shortenAddress(nft.seller)}</p>
            <p className='font-poppins dark:text-white text-nft-black-1 font-semibold
              text-sm minlg:text-xl'>{nft.name}</p>
          </div>
        </div>   
        <div>
...
const NftDetails = () => {
  ...
  return (
    <div className='relative flex justify-center md:flex-col min-h-screen'>
      <div className='relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 
        md:border-b dark:border-nft-black-1 border-nft-gray-1'>
      ...
      <div className='flex-1 justify-start sm:px-4 p-12 sm:pb-4'>
        <div className='flex flex-row sm:flex-col'>
          <h2 className='font-poppins dark:text-white text-nft-black-1 font-semibold
          text-2xl minlg:text-3xl'>{nft.name}</h2>
        </div>

        <div className='mt-10'>
          <p className='font-poppins dark:text-white text-nft-black-1 text-xs minlg:text-base
            font-normal'>Creator</p>
          <div className='flex flex-row items-center mt-3'>
            <div className='relative w-12 h-12 minlg:w-20 minlg:h-20 mr-2'>
              <Image src={images.creator1} objectFit='cover' className='rounded-full' />
            </div>
            <p className='font-poppins dark:text-white text-nft-black-1 text-xs minlg:text-base
              font-semibold'>{shortenAddress(nft.seller)}</p>
          </div>

          <div className='mt-10 flex flex-col'>
            <div className='w-full border-b dark:border-nft-black-1 border-nft-gray-1 flex flex-row'>
              <p className='font-poppins dark:text-white text-nft-black-1 text-base minlg:text-base
              font-medium mb-2'>Details</p>
            </div>
            <div className='mt-3'>
              <p className='font-poppins dark:text-white text-nft-black-1 text-base
                font-normal'>{nft.description}</p>
            </div>
          </div>
          ...
          <div className='flex flex-row sm:flex-col mt-10'>
            {currentAccount === nft.seller.toLowerCase() ? (
              ...
              <Button btnName="List on Marketplace" 
